...
История проекта до отделения от апстрима: версии 3.0.0–5.0.0, репозиторий
[`theYahia/yandex-direct-mcp`](https://github.com/theYahia/yandex-direct-mcp)
(заархивирован) и вклад [Maxim (DrSeedon)](https://github.com/DrSeedon),
расширивший сервер с 20 до 48 инструментов.

Файл сохранён ради атрибуции и истории и больше не пополняется. `yd-mcp`
развивается самостоятельно под именем `yandex-direct-mcp-plus` с собственной
нумерацией начиная с 1.0.0 — текущие изменения см. в
