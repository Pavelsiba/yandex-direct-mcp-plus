...
export async function handleManageDynamicTargets(params: z.infer<typeof manageDynamicTargetsSchema>): Promise<string> {
  ...
  return formatResult(
    await apiPost("dynamictextadtargets", params.action, {
