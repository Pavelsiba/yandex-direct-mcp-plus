...
export const listAdsTool = defineTool({
  ...
  description:
    "Объявления в группах: заголовки, тексты, ссылки, статусы, тип и подтип объявления, привязанные сайтлинки, " +
    "визитка и изображение. Причина отказа модерации приходит в StatusClarification. " +
    "Отбор только по группам — по ID объявления не ищет. " +
