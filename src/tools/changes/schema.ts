...
export const getChangesSchema = z.object({
  ...
  campaign_ids: z
    ...
    .check(
      ...
      z.maxLength(MAX_CAMPAIGNS_PER_CHANGES_CALL, {
        error: `Не больше ${MAX_CAMPAIGNS_PER_CHANGES_CALL} кампаний за вызов`
      })
    )
    .optional()
  ...
  ad_group_ids: z
    ...
    .check(
      ...
      z.maxLength(MAX_AD_GROUPS_PER_CHANGES_CALL, {
        error: `Не больше ${MAX_AD_GROUPS_PER_CHANGES_CALL} групп за вызов`
      })
    )
    .optional()
  ...
  ad_ids: z
    ...
    .check(
      ...
      z.maxLength(MAX_ADS_PER_CHANGES_CALL, { error: `Не больше ${MAX_ADS_PER_CHANGES_CALL} объявлений за вызов` })
    )
    .optional()
