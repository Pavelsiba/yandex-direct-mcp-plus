...
// Срезы плоские, обязательность проверяет хендлер: иначе схема стала бы тринадцатью вариантами.
...
// Каждый список — здесь, их произведение (лимит элементов запроса) — в хендлере.
