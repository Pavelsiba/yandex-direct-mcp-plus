// Две сущности: минус-фразы внутри кампании или группы и общие наборы уровня аккаунта со
// своим сервисом и привязкой. И те и другие Директ перезаписывает целиком — отсюда set_*/link_*.
import { z } from "zod"
...
// Без значения по умолчанию намеренно: пропуск на просьбе «добавь фразу» при replace молча
// стёр бы весь список.
...
// Оба списка необязательны, но хотя бы один нужен: иначе «ничего не сделал» вернулось бы успехом.
